...
public class setComponentId {
	

	public static void setcomponentId(String filepath, int count, PrintWriter writer) {
        ...
        dataObject.put("component_name", allValues.fossidvalues.getComponent());
        dataObject.put("component_version", allValues.fossidvalues.getVersion());
        dataObject.put("preserve_existing_identifications", "1");
        
		JSONObject rootObject = new JSONObject();
        rootObject.put("group", "files_and_folders");
        rootObject.put("action", "set_identification_component");
		...
		try {
			...
			System.out.println("[ERROR] setComponentid: " + e);
			e.printStackTrace();
